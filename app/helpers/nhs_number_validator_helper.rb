...
module NhsNumberValidatorHelper
  def validate_nhs_number_correctness(number)
    if number.nil?
      {
        valid: false,
        message: I18n.t("coronavirus_form.nhs_number.errors.missing"),
      }
    elsif !is_number?(number)
      {
        valid: false,
        message: I18n.t("coronavirus_form.nhs_number.errors.must_be_a_number"),
      }
    elsif !is_ten_digits?(number)
      {
        valid: false,
        message: I18n.t("coronavirus_form.nhs_number.errors.must_be_ten_digits"),
      }
    elsif !valid_check_digit?(number.to_i)
      {
        valid: false,
        message: I18n.t("coronavirus_form.nhs_number.errors.must_have_checksum"),
      }
    else
      {
        valid: true,
