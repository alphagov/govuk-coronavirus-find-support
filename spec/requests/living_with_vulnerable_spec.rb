RSpec.describe "living-with-vulnerable" do
  describe "GET /living-with-vulnerable" do
    let(:selected_option) { I18n.t("coronavirus_form.questions.living_with_vulnerable.options").sample }
    ...
    context "without session data" do
      it "shows the form" do
        ...
        I18n.t("coronavirus_form.questions.living_with_vulnerable.options").each do |option|
  ...
  describe "POST /living-with-vulnerable" do
    ...
    xit "shows an error when no radio button selected" do
      ...
      expect(response.body).to have_content(I18n.t("coronavirus_form.questions.living_with_vulnerable.title"))
      expect(response.body).to have_content(I18n.t("coronavirus_form.questions.living_with_vulnerable.custom_select_error"))
    end
  end
end
