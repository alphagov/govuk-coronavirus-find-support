RSpec.describe "have-somewhere-to-live" do
  describe "GET /have-somewhere-to-live" do
    let(:selected_option) { I18n.t("coronavirus_form.questions.have_somewhere_to_live.options").sample }

    context "without session data" do
      it "shows the form" do
        visit have_somewhere_to_live_path

        expect(page.body).to have_content(I18n.t("coronavirus_form.questions.have_somewhere_to_live.title"))
        I18n.t("coronavirus_form.questions.have_somewhere_to_live.options").each do |option|
  ...
  describe "POST /have-somewhere-to-live" do
    ...
    xit "shows an error when no radio button selected" do
      ...
      expect(response.body).to have_content(I18n.t("coronavirus_form.questions.have_somewhere_to_live.title"))
      expect(response.body).to have_content(I18n.t("coronavirus_form.questions.have_somewhere_to_live.custom_select_error"))
    end
  end
end
